...
export function App() {
  ...
  return (
    <div className="operator-shell flex flex-col overflow-hidden bg-s1 text-tx font-sans">
      ...
      <div className="operator-body flex min-h-0 flex-1">
        <Rail
          mode={op.mode}
          onMode={op.setMode}
          surface={op.surface}
        ...
        <main
          id="main-content"
          tabIndex={-1}
          className="motion-focal operator-main flex min-h-0 flex-1 flex-col"
        >
