...
| 22 | OPEN — ouverture 2026-04-19 thème composition 3 couches Sybil-resistance + rate-limit engine wire + GLiNER span-decoder + NVML baseline + watermark canari primitive + LT-2 reclassification | `<HEAD>` (kickoff chore) | 1 chore planning ouverture (kickoff + plan + design_review G1 CONDITIONAL PASS + carry_summary + HARDENING §3 S22/S23/S24/S27 updates + FAIRNESS §7 résolu + ROADMAP_COMMITMENTS §LT-2 new + SPRINT_LOG row) | 4 docs planning (kickoff, plan, design_review, carry_summary) + 8 chore planning docs updates (HARDENING §3 S22/S23/S24/S27 + FAIRNESS §7 + ROADMAP_COMMITMENTS LT-2 + SPRINT_LOG + memory) |
